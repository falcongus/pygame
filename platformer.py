...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        for x in range(0, SCREEN_WIDTH*10, SPRITE_SIZE//2):
        ...
        # Draw the platform
        for x in range(SPRITE_SIZE * 3, SPRITE_SIZE* 100,SPRITE_SIZE//2):
            wall = arcade.Sprite("images/grassMid.png", SPRITE_SCALING)
        ...
        # -- Set up the player
        self.player_sprite = arcade.Sprite("images/3/3_enemies_1_run_000.png", 0.1)
        self.player_sprite1=arcade.Sprite("images/4/4_enemies_1_run_000.png",0.1)
        ...
        self.player_sprite1.center_y = 270
